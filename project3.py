# attrition_dashboard_combined_app.py
...
# ---------------------- Employee Attrition Prediction ---------------------- #
if section == "Employee Attrition Prediction":
    ...
    df = load_data()
    dashboard_tab = st.radio("Choose Tab", ["🔍 Prediction", "📊 EDA", "📈 Model Evaluation Results"])

    if dashboard_tab == "🔍 Prediction":
    ...
    if st.button("🔎 Predict Attrition"):
        ...
        # 🎯 Performance Tenure Breakdown Chart
    ...
    elif dashboard_tab == "📈 Model Evaluation Results":
...
# ---------------------- Employee Prediction ---------------------- #
elif section == "Employee Prediction":
    st.header("🔍 Employee Prediction")
    ...
    encoded_input = pd.DataFrame([[age, department_map[department], monthly_income, job_satisfaction,
                                   years_at_company, marital_map[marital_status], overtime_map[over_time]]],
...
# ---------------------- Employee Performance Rating Prediction ---------------------- #
elif section == "Employee Performance Rating Prediction":
    st.header("🎯 Employee Performance Rating Prediction")
